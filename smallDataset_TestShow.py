...
from Video_Dataset import small_Dataset_for_show
import torch
...
def TestSmallDataset(Model_name,numOfJenre,classes_file): #model is str, numOfJenre is number, classes_file is txt file
    ...
    test_path_videos = os.path.join(filename, 'test_show')
    test_dataset = small_Dataset_for_show(test_path_videos, os.path.join(filename, classes_file), seq, (180, 220),numOfJenre)
